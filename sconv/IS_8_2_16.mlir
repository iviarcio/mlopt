...
#map7 = affine_map<(d0, d1) -> (d0 + d1 - (d1 floordiv 3) * 3)>
      ...
      %2 = scf.for %arg7 = %c0_1 to %c4096 step %c32 iter_args(%arg8 = %arg6) -> (tensor<1x256x4096xf32>) {
        %3 = scf.for %arg9 = %c0_2 to %c256 step %c64 iter_args(%arg10 = %arg8) -> (tensor<1x256x4096xf32>) {
          ...
          %6 = scf.for %arg11 = %c0_7 to %c32_9 step %c16_10 iter_args(%arg12 = %extracted_slice_5) -> (tensor<1x64x32xf32>) {
            ...
            %extracted_slice_11 = tensor.extract_slice %extracted_slice[0, 0, %7, %8] [1, 16, 3, 18] [1, 1, 1, 1] : tensor<1x16x3x34xf32> to tensor<1x16x3x18xf32>
            %9 = tensor.empty() : tensor<1x144x16xf32>
            %10 = linalg.generic {indexing_maps = [#map2], iterator_types = ["parallel", "parallel", "parallel"]} outs(%9 : tensor<1x144x16xf32>) {
            ^bb0(%out: f32):
              ...
              %17 = affine.apply #map5(%13)
              %18 = affine.apply #map6(%13)
              %19 = affine.apply #map7(%14, %13)
              %extracted = tensor.extract %extracted_slice_11[%12, %15, %17, %19] : tensor<1x16x3x18xf32>
              linalg.yield %extracted : f32
            } -> tensor<1x144x16xf32>
            %11 = scf.for %arg13 = %c0_6 to %c64_8 step %c8 iter_args(%arg14 = %arg12) -> (tensor<1x64x32xf32>) {
              %extracted_slice_12 = tensor.extract_slice %extracted_slice_4[%arg13, 0, 0, 0] [8, 16, 3, 3] [1, 1, 1, 1] : tensor<64x16x3x3xf32> to tensor<8x16x3x3xf32>
              %extracted_slice_13 = tensor.extract_slice %arg14[0, %arg13, %arg11] [1, 8, 16] [1, 1, 1] : tensor<1x64x32xf32> to tensor<1x8x16xf32>
              %12 = tensor.empty() : tensor<144x8xf32>
              %13 = linalg.generic {indexing_maps = [#map8], iterator_types = ["parallel", "parallel"]} outs(%12 : tensor<144x8xf32>) {
              ^bb0(%out: f32):
                ...
                %extracted = tensor.extract %extracted_slice_12[%16, %17, %19, %20] : tensor<8x16x3x3xf32>
                linalg.yield %extracted : f32
              } -> tensor<144x8xf32>
              %14 = linalg.generic {indexing_maps = [#map9, #map10, #map11], iterator_types = ["parallel", "parallel", "parallel", "reduction"]} ins(%10, %13 : tensor<1x144x16xf32>, tensor<144x8xf32>) outs(%extracted_slice_13 : tensor<1x8x16xf32>) {
              ^bb0(%in: f32, %in_15: f32, %out: f32):
                %15 = arith.mulf %in, %in_15 : f32
                %16 = arith.addf %15, %out : f32
                linalg.yield %16 : f32
              } -> tensor<1x8x16xf32>
              %inserted_slice_14 = tensor.insert_slice %14 into %arg14[0, %arg13, %arg11] [1, 8, 16] [1, 1, 1] : tensor<1x8x16xf32> into tensor<1x64x32xf32>
              scf.yield %inserted_slice_14 : tensor<1x64x32xf32>
            }
            scf.yield %11 : tensor<1x64x32xf32>
          }
